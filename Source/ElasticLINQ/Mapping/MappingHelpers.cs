...
namespace ElasticLinq.Mapping
{
    ...
    public static class MappingHelpers
    {
        ...
        /// <param name="culture">CultureInfo to be used to lower-case first word.</param>
        ...
        public static string ToCamelCase(this string value, CultureInfo culture)
        {
            ...
            return string.Concat(culture.TextInfo.ToLower(words.First()), string.Concat(words.Skip(1)));
        }
        ...
        public static string ToPlural(this string value, CultureInfo culture)
        {
            ...
            return value.Length < 1
                ? value
                : value + (culture.CompareInfo.IsSuffix(value, "s", CompareOptions.IgnoreCase) ? "" : "s");
        }
        ...
        /// A type selection property should be a public read/write instance property that is not generic.
        /// </remarks>
        static readonly Func<PropertyInfo, bool> basicTypeSelectionPropertyCriteria = p =>
        ...
        /// </remarks>
        static readonly Func<TypeInfo, PropertyInfo> requiredProperty = t =>
