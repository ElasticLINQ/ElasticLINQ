...
namespace ElasticSpiking.BasicProvider.Elastic
{
    using System;
    using System.Linq;
    ...
    namespace ElasticSpiking.BasicProvider
    {
        ...
        internal class DbQueryTranslator : global::ElasticSpiking.BasicProvider.ExpressionVisitor
        {
            private ColumnProjection projection;
            private ParameterExpression row;
            private StringBuilder sb;

            internal global::ElasticSpiking.BasicProvider.TranslateResult Translate(Expression expression)
            {
                sb = new StringBuilder();
                row = Expression.Parameter(typeof(ProjectionRow), "row");
                Visit(expression);
                return new global::ElasticSpiking.BasicProvider.TranslateResult
                {
